...
合计: **2,384,924** 行代码（覆盖前 5 种语言、共 **10904** 个文件）。
...
- **最新版本**: `docker-v29.8.0` (2026-09-03)
- **最近提交**: 2026-09-10

## 流行度

- **Star**: 72,078 · **Fork**: 19,220 · **开放 issue**: 23,626 · **贡献者**: 2,327

## 累计统计

- **发布数**: 312 · **已合并 PR**: 23187 · **开放 PR**: 608 · **已关闭 issue**: 20346 · **开放 issue**: 3280 · **提交数**: 57915
...
在 [repology.org](https://repology.org/project/moby) 上共有 **92** 个发行版报告此项目。**9** 个 ✅ 已是最新上游版本，**65** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T23:33:45Z._
